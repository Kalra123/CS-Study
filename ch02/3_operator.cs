 ...
 * 이름 조진호
 * 날짜 2022 / 06 / 02
 * 내용 연산자(operator) 실습하기 교재p90
 * 
 * 연산자(operator)
 * - 변수에 저장된 데이터의 처리를 위해 연산자를 이용
 * - 연산자는 크게 산출, 증가감소, 복합대입, 비교, 논리 연산자 등이 있다.
 */
namespace ch02
{
    internal class _3_operator
    {
        static void Main1(string[] args)
        {
         ...
         // 비교 연산자  
            ...
            bool res5 = !(val1 > val2);     //val1이 val2보다 크지않다.
            ...
            string result = (a > 1) ? "a는 1보다 크다." : "a는 1보다 크지 낳다";
